...
public class TransactionsController {
    ...
    public TransactionDtos getTransactions() {
        ...
        TransactionDtos transactionDtos = TransactionDtos.builder().build();
        transactionDtos.setTransactionDto(
    ...
    public TransactionDtos findByAccountId(@PathVariable("id") Integer id) {
        List<TransactionDto> transactionDtos =
                transactionsService.findByAccountId(id).stream()
                        .map(transactionMapper::toDto)
                        .collect(Collectors.toList());
    ...
    @GetMapping(
            value = "/accounts/{accountId}/transactions/{transactionId}",
            produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
    @ResponseStatus(code = HttpStatus.OK)
    ...
    public TransactionDto findByAccountIdAndTransactionId(
            @PathVariable("accountId") Integer accountId,
            @PathVariable("transactionId") Integer transactionId) {
        return transactionMapper.toDto(
                transactionsService.findByAccountIdAndTransactionId(accountId, transactionId));
    }
    ...
    public TransactionDto create(@RequestBody @Valid TransactionDto transactionDto) {
        return transactionMapper.toDto(
                transactionsService.createOrUpdateTransaction(transactionDto));
    }
    ...
    public TransactionDto update(
            @RequestBody @Valid TransactionDto transactionDto, @PathVariable("id") Integer id) {
